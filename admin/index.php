...
<div id="wrapper">
    ...
    <div class="sidebar-collapse">
        <ul class="nav" id="main-menu">
            ...
            <li>
                <a href="index.php?halaman=kategori"><i class="fa fa-list"></i> Kategori Produk</a>
            </li>
            <li>
                <a href="index.php?halaman=produk"><i class="fa fa-archive "></i> Produk</a>
            </li>
            <li>
            ...
            <li>
                <a href="index.php?halaman=logout"><i class="fa fa-power-off "></i> Logout</a>
            </li>
        </ul>
    </div>
    </nav>
